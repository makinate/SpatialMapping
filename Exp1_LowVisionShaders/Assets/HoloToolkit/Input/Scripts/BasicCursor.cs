...
namespace HoloToolkit.Unity
{
    ...
    public class BasicCursor : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if ((GazeManager.Instance.RaycastLayerMask & this.gameObject.layer) == 0) // these two need to be the same
            {
                ...
                Debug.Log("GazeManager.Instance.RaycastLayerMask: " + GazeManager.Instance.RaycastLayerMask);
                Debug.Log("This GameObject's layer: " + this.gameObject.layer);
                Debug.Log(1 & 1);
                Debug.Log(1 & 0);
                Debug.Log(GazeManager.Instance.RaycastLayerMask & this.gameObject.layer); 
